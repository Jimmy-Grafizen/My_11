...
jQuery(document).ready(function() {
	//MobileMenu
	/*if ($(window).width() < 768){
		jQuery('header').prepend('<a href="javascript:void(0)" class="menu_toggler"><span class="fa fa-align-justify"></span></a>');
...
$(document).ready(function() {
	...
	//WORKS SLIDER
    var owl = $(".owl-demo.ourMenu_slider");
    ...
    owl.owlCarousel({
	 ...
	 var owl = $(".owl-demo.ourFood_slider");
...
jQuery(document).ready(function() {jQuery(".dropdown-menu li a").click(function(){
