    ...
    this.each(function() {
      ...
      <div class="imageuploadify well">
        ...
        <div class="imageuploadify-images-list text-center">
          ...
          <button type="button" class="btn btn-default">Drag & Drop Your File(s) or select file to upload</button>
        </div>
      </div>
      `);
      ...
      const readingFile = (id, file) => {
        ...
        if (file.type && file.type.search(/image/) != -1) {
          ...
          fReader.onloadend = function (e) {
            ...
            imagesList.find(".imageuploadify-container:nth-child(" + boxesNb + "n+4)").css("margin-left", marginSize+5 + "px");
            imagesList.find(".imageuploadify-container:nth-child(" + boxesNb + "n+3)").css("margin-right", marginSize+5 + "px");
          };
        ...
        $(window).resize(function () {
          ...
          window.resizeEvt = setTimeout(function() {
            ...
            for (let index = 0; index < containers.length; ++index) {
              $(containers[index]).css("margin-right", "5px");
              $(containers[index]).css("margin-left", marginSize + "5px");
            }

            // Apply left margin to first container of each row and right to last.
            imagesList.find(".imageuploadify-container:nth-child(" + boxesNb + "n+4)").css("margin-left", marginSize + "5px");
            imagesList.find(".imageuploadify-container:nth-child(" + boxesNb + "n+3)").css("margin-right", marginSize + "5px");
          }, 500);
        });
      })
