...
class Cricket_teams extends Base {

    private $limit = 10;
    private $table = 'tbl_cricket_teams';
    private $image = '';
    private $prefixUrl = 'admin/cricket_teams/';
    private $name = 'Cricket Teams'; // For singular
    private $names = 'Cricket Teams'; //plural form 
    ...
    public function add() {
        ...
        $data['title'] = "Add New {$this->names}";
         ...
         $this->form_validation->set_rules('name', 'Name', "trim|required|is_unique[tbl_cricket_teams.name]");
            $this->form_validation->set_message('is_unique', 'This Team is already taken in ' . SITE_TITLE . ". Please try different");
