...
class Countries extends Base {
    ...
    private $image = '';
    private $prefixUrl = 'admin/countries/';
    private $name = 'Country'; // For singular
    private $names = 'Countries'; //plural form 
...
// add new user
    public function add() {
        ...
        $data['title'] = "Add New {$this->names}";
         ...
         $this->form_validation->set_rules('name', 'Name', "trim|required|is_unique[tbl_countries.name]");
            $this->form_validation->set_message('is_unique', 'This Country is already taken in ' . SITE_TITLE . ". Please try different");
...
// edit user detail
    public function edit() {
        ...
        if (!empty($user_detail)) {
            ...
            $this->form_validation->set_rules('name', 'Name', "trim|required|is_unique_again[tbl_countries.name.$id]");
            $this->form_validation->set_message('is_unique_again', 'This Country is already taken in ' . SITE_TITLE . ". Please try different");
            if ($this->form_validation->run() == FALSE) {
