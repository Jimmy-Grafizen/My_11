...
class Taxes extends Base {
    ...
    private $limit      = 10;
    private $table      = 'tbl_taxes';
    private $image      = '';
    private $prefixUrl  = 'admin/taxes/';
    private $name       = 'Tax'; // For singular
    private $names      = 'Taxes'; // For plural  
    ...
    public function add() {
        ...
        $data['title'] = "Add New {$this->names}";
			...
			$this->form_validation->set_rules('value', $this->name.' Amount (in %)', "trim|required");
    ...
    public function edit() {
        ...
        if (!empty($user_detail)) {
            ...
            $this->form_validation->set_rules('name', 'Name', "trim|required|is_unique_again[tbl_taxes.name.$id]");
