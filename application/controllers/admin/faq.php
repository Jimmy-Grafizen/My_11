...
class Faq extends Base {
    ...
    private $tcm = '';
    private $image = '';
    private $prefixUrl = 'admin/faq/';
    private $name = 'Faq'; // For singular
    private $names = 'Faqs'; //plural form 
...
//echo $this->prefixUrl;
    ...
    public function add() {
     ...
     /*   echo '<pre>';print_r($_POST); die;*/
        ...
        $rowFaqCatInfo =  $this->main_model->cruid_select_array($table, $select_fields, $cond);
        /*echo '<pre>';
        print_r($rowFaqCatInfo);
        echo '</pre>';*/
    ...
    public function edit() {
		...
		$tablee = "tbl_faq_category";
        $condd = "is_deleted ='N'";
        $select_fieldss = "tbl_faq_category.*";
        $rowFaqCatInfo =  $this->main_model->cruid_select_array($tablee, $select_fieldss, $condd);
        /*echo '<pre>';
        print_r($rowFaqCatInfo);
        echo '</pre>';*/
        $data['rowFaqCatInfo']=$rowFaqCatInfo;
