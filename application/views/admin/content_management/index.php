                ...
                <section class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        <!-- <div class="form-group">
                            ...
                            $value = set_value("page_name") ? set_value("page_name") : (isset($user_detail['page_name']) ? $user_detail['page_name'] : '');
                            echo form_dropdown('page_name', $opt1, $value, 'class="form-control search_fields required" id="page_name"');*/
                            ?>
                        </div> -->
                        ...
                        <div class="form-group">
                            ...
                            $value = set_value("app_type") ? set_value("app_type") : (isset($user_detail['app_type']) ? $user_detail['app_type'] : '');
                           // echo form_dropdown('app_type', $opt2, $value, 'class="form-control search_fields required" id="app_type"');
                            ?>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            $value = set_value("platform") ? set_value("platform") : (isset($user_detail['platform']) ? $user_detail['platform'] : '');
                            echo form_dropdown('platform', $opt3, $value, 'class="form-control search_fields required" id="platform"');
                            ?>
                        </div>
