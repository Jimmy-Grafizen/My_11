                            ...
                            <div class="form-group ">
                                <div class="col-lg-10">
                                    ...
                                    <?php
									  ...
									  $opt_all = $this->main_model->cruid_select_array_order("tbl_games", "tbl_games.name,id", $joins = array(), $cond = array("is_deleted" => 'N'), $order_by = array(), $limit = '', $order_by_other = array());
									  
                                    $opt[''] = "Please Select Games";
                                    if (!empty($opt_all)) {
                                    ...
                                    echo form_dropdown('game_id', $opt, $value, 'class="form-control required search_fields" id="game_id"');
                                    ?>
                                </div>
                            </div>
                            */ ?>
