                    ...
                    <div class="panel-body"><?php $this->load->view('element/actionMessage'); ?>
                        ...
                        <div class=" form">
                            ...
                            <div class="form-group ">
                                <label for="game_id" class="control-label col-lg-2">Games  <span class="red_star">*</span></label>
                                <div class="col-lg-10">
			
                                    <?php
                               
									  $opt_all = $this->main_model->cruid_select_array_order("tbl_games", "tbl_games.name,id", $joins = array(), $cond = array("id" => '0',"is_deleted" => 'N'), $order_by = array(), $limit = '', $order_by_other = array());
                            ...
                            <div class="form-group ">
                                ...
                                <div class="form-group">
                                    <div class="col-lg-offset-2 col-lg-10">
                                        ...
                                        <a class="btn btn-default" href="<?php echo HTTP_PATH . "admin/game_types" ?>">Cancel</a>
                                    </div>
                                </div>
                                <?php echo form_close(); ?>
                            </div>
