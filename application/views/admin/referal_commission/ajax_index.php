                    ...
                    <section id="no-more-tables">
                        <table class="table table-bordered table-striped table-condensed cf">
                            <thead class="cf">
                                <tr>
                                    <th></th>
                                   	 <th class="<?php echo $this->main_model->getsortclass("game_name", $field, $sort_type); ?> enable-sort" sort_type="<?php echo $sort_type ?>" field="game_name">Sports</th>
                                    <th class="<?php echo $this->main_model->getsortclass("game_type_name", $field, $sort_type); ?> enable-sort" sort_type="<?php echo $sort_type ?>" field="game_type_name">Game Type</th>
                                    <th class="<?php echo $this->main_model->getsortclass("{$table}.name", $field, $sort_type); ?> enable-sort" sort_type="<?php echo $sort_type ?>" field="<?=$table?>.commission">Commission</th>
                                ...
                                foreach ($records as $row) {
                                    ...
                                    <tr>
										...
										<td data-title="City name">
                                            <?php echo ucfirst($row->commission); ?>
                                        </td>
