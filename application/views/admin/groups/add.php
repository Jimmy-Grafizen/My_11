                                            ...
                                            <div class="col-lg-12" style="margin-left: 20px">
                                                ...
                                                if(!empty($val)) {
                                                    foreach ($val as $id => $label) {
                                                        # code...
                                                        ?>
                                                        <div class="col-lg-4 links" style="padding: 5px"> <a href="javascript:void(0)" data-node="<?php echo "['".$key."'][$id].level"; ?>"  data-level="0"  class="change-groups fa"> <?php echo $label['label'] ?> </a> </div>
                                                        <?php
                                                    }
                                                }
                                                ?>
