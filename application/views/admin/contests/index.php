                            ...
                            <div class="form-group ">
                                <div class="col-lg-10">
                                    ...
                                    <?php
									  ...
									  $opt_all = $this->main_model->cruid_select_array_order("$tccc", "name,id", $joins = array(), $cond = array("is_deleted" => 'N',"is_beat_the_expert" => 'N',"is_private" => 'N'), $order_by = array("field"=>"name","type"=>"ASC"), $limit = '', $order_by_other = array());
									  
                                    $opt[''] = "Please Select Categories";
                                    if (!empty($opt_all)) {
                                    ...
                                    echo form_dropdown('category_id', $opt, $value, 'class="form-control required search_fields" id="category_id"');
                                    ?>
                                </div>
                            </div>
                        <div class="form-group">
