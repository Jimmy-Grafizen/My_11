            ...
            <div class="col-lg-12">
                ...
                <section class="panel">
                    ...
                    <div class="panel-body"><?php $this->load->view('element/actionMessage'); ?>
                        ...
                        <div class=" form">
                            <?php echo form_open_multipart('' . $user_detail['slug'] . "?return=" . $this->input->get("return"), array('method' => 'post', 'class' => 'cmxform form-horizontal tasi-form form', 'id' => 'myform')) ?>
                            ...
                            <div class="form-group ">
                                ...
                                <div class="form-group">
                                    <div class="col-lg-offset-2 col-lg-10">
                                        ...
                                        <a class="btn btn-default" href="<?php echo HTTP_PATH . "admin/admins" ?>">Cancel</a>
                                    </div>
                                </div>
                                <?php echo form_close(); ?>
                            </div>
