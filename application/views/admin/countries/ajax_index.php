        ...
        <div class="col-lg-12">
            <section class="panel">
                <div class="panel-body border-bottom">
                    ...
                    ?>
                    Number of Countries <span class="badge-gray"><?php echo $start; ?></span> - <span class="badge-gray"><?php echo $till_record; ?></span> out of <span class="badge-gray"><?php echo $total_rows; ?></span>
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <section class="panel">
                ...
                <div class="panel-body">
                    <section id="no-more-tables">There are no Countries added on site yet.</section>
                </div>
            </section>
        </div>
    </div>  
