                        ...
                        <table class="table table-bordered table-striped table-condensed cf">
                            <thead class="cf">
                                <tr>
                                    ...
                                    <th class="<?php echo $this->main_model->getsortclass("{$table}.name", $field, $sort_type); ?> enable-sort" sort_type="<?php echo $sort_type ?>" field="<?=$table?>.sort_name">Sort Name</th>
									<th>Image</th>
                                    <th>Created By</th>
                                    <th class="<?php echo $this->main_model->getsortclass("{$table}.updated_at", $field, $sort_type); ?>  enable-sort" sort_type="<?php echo $sort_type ?>"  field="<?=$table?>.updated_at">Last Updated Date</th>
                                    <th>Action</th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                foreach ($records as $row) {
                                    ...
                                    <tr>
                                        ...
                                        <td data-title="Name">
                                            <?php echo ucfirst($row->sort_name); ?>
                                        </td>
                                        <td data-title="Image">										
                                   <?php
                                        if($row->logo!=""){
                                            echo '<img src="'.$row->logo.'" style="width: 120px;height: 120px;">';
                                        }else{
                                    ...
                                    ?>
                                        ...
                                        <td data-title="Last Updated Date">
                                            <?php echo $row->updated_at ? date(DATE_TIME_FORMAT_ADMIN, $row->updated_at) : ""; ?></td>
                                        <td data-title="Action">
                                            ...
                                            <i class="fa fa-file-image-o image_change"  data-toggle="modal" data-target="#myModal" modaldata='<?=json_encode($row,JSON_HEX_APOS);?>'></i></button>
                                        </td>	
                                    </tr>
                                <?php } ?>
                            </tbody>
        ...
        <div class="col-lg-12">
            <section class="panel">
                <div class="panel-body border-bottom">
                    ...
                    ?>
                    Number of Teams <span class="badge-gray"><?php echo $start; ?></span> - <span class="badge-gray"><?php echo $till_record; ?></span> out of <span class="badge-gray"><?php echo $total_rows; ?></span>
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <section class="panel">
                ...
                <div class="panel-body">
                    <section id="no-more-tables">There are no Teams added on site yet.</section>
                </div>
            </section>
        </div>
    </div>  
