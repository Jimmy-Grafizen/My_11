                        ...
                        <div class=" form">
                            ...
                            <div class="form-group ">
                                ...
                                <div class="col-lg-10">
                                    ...
                                    echo form_dropdown('country_id', $opt, $value, 'class="form-control required" id="country"');
                                    ?>
                                </div>
                            </div>
                            ...
                            <div class="form-group ">
                                ...
                                <div class="col-lg-10">
									<select name="state_id" class="reason form-control required valid" id="state_id">
                            ...
                            <div class="form-group ">
                                <label for="name" class="control-label col-lg-2">City Name  <span class="red_star">*</span></label>
                                <div class="col-lg-10">
                                    <?php
