                        ...
                        <table class="table table-bordered table-striped table-condensed cf">
                            <thead class="cf">
                                <tr>
                                    ...
                                    <th class="<?php echo $this->main_model->getsortclass("tbl_states.name", $field, $sort_type); ?> enable-sort" sort_type="<?php echo $sort_type ?>" field="tbl_states.name">State</th>
                                    <th class="<?php echo $this->main_model->getsortclass("{$table}.name", $field, $sort_type); ?> enable-sort" sort_type="<?php echo $sort_type ?>" field="<?=$table?>.name">City</th>
        ...
        <div class="col-lg-12">
            <section class="panel">
                <div class="panel-body border-bottom">
                    ...
                    ?>
                    Number of Cities <span class="badge-gray"><?php echo $start; ?></span> - <span class="badge-gray"><?php echo $till_record; ?></span> out of <span class="badge-gray"><?php echo $total_rows; ?></span>
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <section class="panel">
                ...
                <div class="panel-body">
                    <section id="no-more-tables">There are no Cities added on site yet.</section>
                </div>
            </section>
        </div>
    </div>  
