                    ...
                    <section id="no-more-tables">
                        <table class="table table-bordered table-striped table-condensed cf">
                            <thead class="cf">
                                <tr>
                                    <th></th>                                   
									<th class="<?php echo $this->main_model->getsortclass("match_name", $field, $sort_type); ?> enable-sort" sort_type="<?php echo $sort_type ?>" field="match_name">Match Name</th>
                             ...
                             <tbody class="row_position">
                                ...
                                foreach ($records as $row) {
                                    ...
                                    <tr  id="<?php echo $row->id; ?>">
                                        ...
                                        <td data-title="Match name">
                                            <?php echo ucfirst($row->match_name); ?>
                                        </td>
