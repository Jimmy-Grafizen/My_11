                    ...
                    <section id="no-more-tables">
                        <table class="table table-bordered table-striped table-condensed cf">
                            <thead class="cf">
                                <tr>
                                    <th></th>                                   
                                     <th class="<?php echo $this->main_model->getsortclass("{$table}.name", $field, $sort_type); ?> enable-sort" sort_type="<?php echo $sort_type ?>" field="<?=$table?>.image">Faq Title</th>
                             ...
                             <tbody class="row_position">
                                ...
                                foreach ($records as $row) {
                                    ...
                                    <tr  id="<?php echo $row->id; ?>">
                                        ...
                                        <td data-title="Faq Title">
									         <?php echo mb_strimwidth(strip_tags(ucfirst($row->name)),0,100,'...'); ?>
                                        </td>
