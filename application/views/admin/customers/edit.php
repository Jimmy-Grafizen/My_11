                    ...
                    <div class="panel-body"><?php $this->load->view('element/actionMessage'); ?>
                        ...
                        <div class=" form">
                            ...
                            <div class="form-group ">
                                ...
                                <label for="is_admin" class="control-label col-lg-2">Is Fake  <span class="red_star">*</span></label>
							...
							<div class="form-group ">
                                ...
                                <div class="col-lg-10">
                                    ...
                                    $dob = set_value("dob") ? set_value("dob") : (isset($user_detail['dob']) ? date( DATE_FORMAT_ADMIN,$user_detail['dob'] ) : '');
							...
							<div class="form-group " style="display: none;">
                                ...
                                <div class="col-lg-10">
                                    ...
                                    $value = set_value("country_id") ? set_value("country_id") : (isset($user_detail['country']) ? $user_detail['country'] : '');

                                    echo form_dropdown('country', $optc, $country_id, 'class="form-control required" id="country"');
                            ...
                            <div class="form-group ">
                                ...
                                <label for="state" class="control-label col-lg-2">States  <span class="red_star">*</span></label>
                               ...
                               $opt_all =null;
									  ...
									  $opt_all = $this->main_model->cruid_select_array_order("tbl_states", "tbl_states.name,id", $joins = array(), $cond = array("is_deleted" => 'N',"country_id" => $country_id), $order_by = array(), $limit = '', $order_by_other = array());
                                    ...
                                    $value = set_value("state_id") ? set_value("state_id") : (isset($user_detail['state']) ? $user_detail['state'] : '');

                                    echo form_dropdown('state', $opt, $value, 'class="reason form-control required" id="state_id"');
                            ...
                            <div class="form-group ">
                                ...
                                <div class="col-lg-10">
                                    ...
                                    $OldVelImg = set_value("image") ? set_value("image") : (isset($user_detail['image']) ? $user_detail['image'] : '');
...
<?php 
    foreach ($profile_pictures as $pictures) { ?>
			...
			<div class="col-xs-3 col-sm-2 col-md-1 col-xl-1 nopad text-center">
				...
				<label class="image-radio <?php echo (!empty($OldVelImg) && $OldVelImg==$pictures['image'])?'image-radio-checked':'';?>" > 

					<img class="img-responsive" src="<?php echo CUSTOMER_IMAGE_THUMB_URL.$pictures['image'] ?>">

						<input type="radio" name="image_radio" value="<?php echo $pictures['image'];?>" <?php echo (!empty($OldVelImg) && $OldVelImg==$pictures['image'])?'checked':'';?> >
...
echo '<img src="'.CUSTOMER_IMAGE_THUMB_URL.$user_detail['image'].'" style="width: 150px;height: 150PX;">';
