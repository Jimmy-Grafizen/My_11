                        ...
                        <table class="table table-bordered table-striped table-condensed cf">
                            <thead class="cf">
                                <tr>
									...
									<th class="<?php echo $this->main_model->getsortclass("series.series_name", $field, $sort_type); ?> enable-sort" sort_type="<?php echo $sort_type ?>" field="series.name">Series Name</th>
                                    <th class="<?php echo $this->main_model->getsortclass("game.game_name", $field, $sort_type); ?>  enable-sort" sort_type="<?php echo $sort_type ?>"  field="game.name">Game name</th>
                                    <th class="<?php echo $this->main_model->getsortclass("game_type.game_type_name", $field, $sort_type); ?>  enable-sort" sort_type="<?php echo $sort_type ?>"  field="game_type.name">Game type</th>
                                    <th class="<?php echo $this->main_model->getsortclass("tbl_teams1.team_1_name", $field, $sort_type); ?>  enable-sort" sort_type="<?php echo $sort_type ?>"  field="tbl_teams1.name">Team-1</th>
                                    <th class="<?php echo $this->main_model->getsortclass("tbl_teams2.team_2_name", $field, $sort_type); ?>  enable-sort" sort_type="<?php echo $sort_type ?>"  field="tbl_teams2.name">Team-2</th>
                                ...
                                foreach ($records as $row) {
                                    ...
                                    <tr>
                                        ...
                                        <td data-title="Action">
                                            <?php
                                            echo anchor($prefixUrl.'edit/' . $row->id . "?return=" . $current_url, '<i class="fa fa-plus"></i>', array('title' => 'Players', 'class' => 'btn btn-primary btn-xs '));
											if ($row->status=="D")
