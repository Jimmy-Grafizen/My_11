                        ...
                        <table class="table table-bordered table-striped table-condensed cf">
                            <thead class="cf">
                                <tr>
                                    ...
                                    <th class="<?php echo $this->main_model->getsortclass("{$table}.playing_squad_updated", $field, $sort_type); ?>  enable-sort" sort_type="<?php echo $sort_type ?>"  field="<?=$table?>.playing_squad_updated">Playing Squad Updated</th>
                                    <th class="<?php echo $this->main_model->getsortclass("{$table}.match_progress", $field, $sort_type); ?>  enable-sort" sort_type="<?php echo $sort_type ?>"  field="<?=$table?>.match_progress">Match Progres</th>
                            ...
                            <tbody>
                                ...
                                foreach ($records as $row) {
                                    ...
                                    <tr>
                                        ...
                                        <td data-title="Playing Squad Updated">
                                            <?php echo ucfirst($row->playing_squad_updated); ?>
                                        </td>

                                        <td data-title="Match Progres">
                                           <?php
                                                $opt_all = unserialize(MATCH_PROGRESS);
                                                echo $opt_all[$row->match_progress]; 
                                            ?>
                                        </td>
                                        ...
                                        <td data-title="Action">
                                            <?php
                                            echo anchor($prefixUrl.'live_contest_match/' . $row->id . "?return=" . $current_url, '<i class="fa fa-trophy"></i>', array('title' => 'View Contests', 'class' => 'btn btn-primary btn-xs m-l-5 m-b-5'));
                                            // echo anchor($prefixUrl.'live_contest_match/' . $row->id . "?v=beat_the_expert&return=" . $current_url, '<i class="fa fa-heartbeat"></i>', array('title' => 'Beat The Expert View', 'class' => 'btn btn-primary btn-xs m-l-5 m-b-5'));
                                            // echo anchor($prefixUrl.'live_contest_match/' . $row->id . "?v=private&return=" . $current_url, '<i class="fa fa-user-secret"></i>', array('title' => 'Private Contests View', 'class' => 'btn btn-primary btn-xs m-l-5 m-b-5'));

											echo anchor($prefixUrl.'view_live/' . $row->id . "?return=" . $current_url, '<i class="fa fa-eye"></i>', array('title' => 'View Match Team', 'class' => 'btn btn-primary btn-xs m-l-5 m-b-5','style' => 'margin-left: 5px;'));
