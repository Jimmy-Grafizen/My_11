...
<div class="chip__kk block_of_player" id="main_kkk"  style="padding-right: 8px;overflow: auto;scroll-behavior: smooth;overflow-y: initial;height: 500px;">
	...
	<?php
		...
		echo @$breckup_points[0]['Every_Boundary_Hit_Value'];
	...
	<?php
		...
		echo @$breckup_points[0]['Every_Boundary_Hit'];
	...
	<?php
		...
		echo @$breckup_points[0]['Thirty_Runs_Value'];
	...
	<?php
		...
		echo @$breckup_points[0]['Thirty_Runs'];
...
;
	...
	<?php
		...
		echo @$breckup_points[0]['Two_Wicket_Value'];
	...
	<?php
		...
		echo @$breckup_points[0]['Two_Wicket'];
	...
	<?php
		...
		echo @$breckup_points[0]['Three_Wicket_Value'];
	...
	<?php
		...
		echo @$breckup_points[0]['Three_Wicket'];
	...
	<div class="col-lg-6">Run Out Catcher
	...
	<?php
		...
		echo @$breckup_points[0]['Run_Out_Catcher_Value'];
	...
	<?php
		...
		echo @$breckup_points[0]['Run_Out_Catcher'];

	?>

	</div>

	<div class="col-lg-6">Run Out Thrower
	...
	<?php
		...
		echo @$breckup_points[0]['Run_Out_Thrower_Value'];
	...
	<?php
		...
		echo @$breckup_points[0]['Run_Out_Thrower'];

	?>

	</div>

	<div class="col-lg-6">Strike Rate
	...
	<?php
		...
		echo @$breckup_points[0]['Strike_Rate_Value'];
	...
	<?php
		...
		echo @$breckup_points[0]['Strike_Rate'];

	?>

	</div>

	<div class="col-lg-6">Economy Rate
	...
	<?php
		...
		echo @$breckup_points[0]['Economy_Rate_Value'];
	...
	<?php
		...
		echo @$breckup_points[0]['Economy_Rate'];
