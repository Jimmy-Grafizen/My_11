                                ...
                                foreach ($records as $row) {
                                    ...
                                    <tr>
                                        ...
                                        <td data-title="Action">
                                            <?php
                                            echo anchor($prefixUrl.'contest_matches_completed/' . $row->id . "?return=" . $current_url, '<i class="fa fa-trophy"></i>', array('title' => 'View Contests', 'class' => 'btn btn-primary btn-xs m-l-5 m-b-5','style' => 'margin-left: 5px;'));
                                        // 	echo anchor($prefixUrl.'contest_matches_completed/' . $row->id . "?v=beat_the_expert&return=" . $current_url, '<i class="fa fa-heartbeat"></i>', array('title' => 'Beat The Expert View', 'class' => 'btn btn-primary btn-xs m-l-5 m-b-5'));
                                        //     echo anchor($prefixUrl.'contest_matches_completed/' . $row->id . "?v=private&return=" . $current_url, '<i class="fa fa-user-secret"></i>', array('title' => 'Private Contests View', 'class' => 'btn btn-primary btn-xs m-l-5 m-b-5'));
                                            echo anchor($prefixUrl.'view_completed/' . $row->id . "?return=" . $current_url, '<i class="fa fa-eye"></i>', array('title' => 'View Match Team', 'class' => 'btn btn-primary btn-xs m-l-5 m-b-5','style' => 'margin-left: 5px;'));
