						...
						<div class="row">
						    <div class="col-lg-2">
							   ...
							   <div class="col-lg-3">
                                    ...
                                    echo form_dropdown('series_id', $opt, $value, 'class="form-control search_fields required" id="series_id"');
                                    ?>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form action="<?=base_url("admin/team_crickets/image_change_save");?>" method="post" id="image_change_save" enctype="multipart/form-data" accept-charset="utf-8">
...
$(document).ready(function(){
    ...
    if (typeof FormData !== 'undefined') {
        var thisEvent = $(this);
        var baseUrl = "<?=base_url("admin/team_crickets/image_upload_save");?>";
