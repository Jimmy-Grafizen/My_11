                        ...
                        <table class="table table-bordered table-striped table-condensed cf">
                            <thead class="cf">
                                <tr>
                                    ...
                                    <th class="<?php echo $this->main_model->getsortclass("{$table}.name", $field, $sort_type); ?> enable-sort" sort_type="<?php echo $sort_type ?>" field="<?=$table?>.name">State</th>
                                    <th class="<?php echo $this->main_model->getsortclass("total_customer", $field, $sort_type); ?> enable-sort" sort_type="<?php echo $sort_type ?>" field="total_customer">Total Customer</th>
                            ...
                            <tbody>
                                ...
                                foreach ($records as $row) {
                                    ...
                                    <tr>
                                        ...
                                        <td data-title="Total Customer">
                                            <?php echo $row->total_customer; ?>
                                        </td>
        ...
        <div class="col-lg-12">
            <section class="panel">
                <div class="panel-body border-bottom">
                    ...
                    ?>
                    Number of State <span class="badge-gray"><?php echo $start; ?></span> - <span class="badge-gray"><?php echo $till_record; ?></span> out of <span class="badge-gray"><?php echo $total_rows; ?></span>
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <section class="panel">
                ...
                <div class="panel-body">
                    <section id="no-more-tables">There are no States added on site yet.</section>
                </div>
            </section>
        </div>
    </div>  
