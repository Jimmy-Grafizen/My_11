                ...
                <section class="panel">
                    ...
                    <div class="panel-body fltrht"><?php $this->load->view('element/actionMessage'); ?>
                        ...
                        <div class=" form">
                            ...
                            <div class="form-group show" style="display:<?php echo ($user_detail['rc_type'] == 1)?'block':'none'; ?>">
                           ...
                           <div class="form-group " id="row_dim">
                            ...
                            <div class="form-group ">
                                ...
                                <?php
                                    ...
                                    $start_date = set_value("start_date") ? set_value("start_date") : (isset($user_detail['start_date']) ? $user_detail['start_date'] : '');
                                ...
                                <div class="col-lg-10">
                                    ...
                                    $start_date = set_value("start_date") ? date(CLOSE_DATE_TIME_FORMAT_ADMIN,strtotime( str_ireplace("/", "-",set_value("start_date") ) ) ): (isset($user_detail['start_date']) ? date(CLOSE_DATE_TIME_FORMAT_ADMIN, strtotime( str_ireplace("/", "-", $user_detail['start_date'] ) ) ): '');
                            ...
                            <div class="form-group ">
                                ...
                                <?php
                                    ...
                                    $end_date = set_value("end_date") ? set_value("end_date") : (isset($user_detail['end_date']) ? $user_detail['end_date'] : '');
                                ...
                                <div class="col-lg-10">
                                    ...
                                    <?php
                                     ...
                                     $end_date = set_value("end_date") ? date(CLOSE_DATE_TIME_FORMAT_ADMIN,strtotime( str_ireplace("/", "-",set_value("end_date") ) ) ): (isset($user_detail['end_date']) ? date(CLOSE_DATE_TIME_FORMAT_ADMIN, strtotime( str_ireplace("/", "-", $user_detail['end_date'] ) ) ): '');
