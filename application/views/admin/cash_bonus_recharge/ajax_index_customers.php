                        ...
                        <table class="table table-bordered table-striped table-condensed cf">
                            <thead class="cf">
                                <tr>
                                    ...
                                    <th class="<?php echo $this->main_model->getsortclass("Recharges_Amount", $field, $sort_type); ?> enable-sort" sort_type="<?php echo $sort_type ?>" field="Recharges_Amount">Recharges Amount</th>
                                ...
                                foreach ($records as $row) {
                                    ...
                                    <tr>                                        
                                        <td data-title="Customer Details">
                                            ...
                                            <?php echo $row->country_mobile_code."-".$row->phone; ?><br>
                                        </td>
                                        ...
                                        <td data-title="Recharges Amount">
                                            <?php echo $row->Recharges_Amount; ?>
                                        </td>
