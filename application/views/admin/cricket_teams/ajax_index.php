                        ...
                        <table class="table table-bordered table-striped table-condensed cf">
                            <thead class="cf">
                                <tr>
									...
									<th class="<?php echo $this->main_model->getsortclass("{$table}.name", $field, $sort_type); ?> enable-sort" sort_type="<?php echo $sort_type ?>" field="<?=$table?>.name">Image</th>
                            ...
                            <tbody>
                                ...
                                foreach ($records as $row) {
                                    ...
                                    <tr>
                                        ...
                                        <td data-title="Image">										
                                    <?php
									if((file_exists(TEAMCRICKET_IMAGE_THUMB_PATH.$row->logo) && isset($row->logo)) || CHECK_IMAGE_EXISTS){
                                        if(!empty($row->logo)){
										echo '<img src="'.TEAMCRICKET_IMAGE_THUMB_URL.$row->logo.'" style="width: 150px;height: 100px;">';
    									}else{
