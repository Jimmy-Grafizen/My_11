                ...
                <section class="panel">
                    ...
                    <div class="panel-body fltrht"><?php $this->load->view('element/actionMessage'); ?>
                        <div class=" form">
                            ...
                            <div class="col-sm-3">
                                <label for="match_date" class="control-label ">Match date [dd-mm-yyyy]  <span class="red_star">*</span></label>
                                <div class="">
                                    <?php
                            ...
                            <div class="col-sm-3">
								...
								<?php
                                    ...
                                    echo form_dropdown('match_progress', $Matchopt, $value, 'class="form-control required" id="match_progress" disabled');
                                    ?>
                                </div>
                            </div>
...
<div class="clearfix"></div>
			...
			<div class="row ">
				...
				<div class="col-xs-6 center-block">
					<h4><b>Our DB players</b></h4><i class="fa fa-spinner fa-pulse fa-3x fa-fw"></i>
				</div>
				</div>
...
$(document).ready(function(){
    ...
    $('#close_date__').datetimepicker({
	 ...
	 $("#our_rec_fetch").load("<?php echo HTTP_PATH . "admin/matches/get_our_db_completed_playes/" ?><?=$user_detail['unique_id'] ?>");
