        ...
        <div class="col-lg-12">
            ...
            <section class="panel">
                <header class="panel-heading">
                    <?php if($export == 'no') { ?>Withdrawals List<?php } ?>
                </header>
                        ...
                        <table class="table table-bordered table-striped table-condensed cf">
                            <thead class="cf">
                                <tr>
									...
									<th class="<?php echo $this->main_model->getsortclass("status", $field, $sort_type); ?>  enable-sort" sort_type="<?php echo $sort_type ?>"  field="status">Status</th>
                                    ...
                                    <th class="<?php echo $this->main_model->getsortclass("updated_at", $field, $sort_type); ?>  enable-sort" sort_type="<?php echo $sort_type ?>"  field="updated_at">Updateed At</th>
                                    ...
                                    <tr>
										...
										<td data-title="Status">
                                         <?php
                                            ...
                                            echo $with_opt_all[$row->status];
                                            ?>
                                        </td>
                                        <td data-title="Created">
                                            <?php echo $row->created_at ? date(DATE_TIME_FORMAT_ADMIN, ($row->created_at)) : "N/A"; ?>
										</td>
                                        <td data-title="Updateed">
                                            <?php echo $row->updated_at ? date(DATE_TIME_FORMAT_ADMIN, ($row->updated_at)) : "N/A"; ?>
										</td>
                                        <?php if($export == 'no') {  ?>
                                            <td data-title="Action">
                                                <?php
                                                 echo '<a href="javascript:;" title="'.ucfirst($row->reason).'"><i class="fa fa-comment"></i></a>';
                                                ?>
                                            </td>	
                                        <?php } ?>
                                    </tr>
