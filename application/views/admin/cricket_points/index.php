                        ...
                        ?>
                            ...
                            <div class="form-group ">
                                <div class="col-lg-10">
                                    ...
                                    echo form_dropdown('country_id', $opt, $value, 'class="form-control search_fields required" id="country"'); */
									
									 $opt_all = $this->main_model->cruid_select_array_order("tbl_game_types", "tbl_game_types.name,id", $joins = array(), $cond = "is_deleted = 'N' AND id IN(SELECT game_type_id FROM `tbl_cricket_points` GROUP BY game_type_id)", $order_by = array(), $limit = '', $order_by_other = array());
                                    ...
                                    $value = set_value("game_type_id") ? set_value("game_type_id") : (isset($user_detail['game_type_id']) ? $user_detail['game_type_id'] : '');
                                    echo form_dropdown('game_type_id', $optc, $value, 'class="form-control required search_fields" id="game_type_id"');
                                    ?>
                                </div>
                            </div>
