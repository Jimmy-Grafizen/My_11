                    ...
                    <section id="no-more-tables">
                        <table class="table table-bordered table-striped table-condensed cf">
                            <thead class="cf">
                                <tr>
								 <th></th>
                                    <th class="<?php echo $this->main_model->getsortclass("{$table}.game_type_id", $field, $sort_type); ?> enable-sort" sort_type="<?php echo $sort_type ?>" field="<?=$table?>.game_type_id">Game Type</th>                                	 
                                    <th class="<?php echo $this->main_model->getsortclass("{$table}.meta_key", $field, $sort_type); ?> enable-sort" sort_type="<?php echo $sort_type ?>" field="<?=$table?>.meta_key">Point Type</th>                                	 
                                    <th class="<?php echo $this->main_model->getsortclass("{$table}.meta_key", $field, $sort_type); ?> enable-sort" sort_type="<?php echo $sort_type ?>" field="<?=$table?>.meta_key">Points</th>
                                ...
                                foreach ($records as $row) {
                                    ...
                                    <tr>  
                                        ...
                                        <td data-title="State Name">
                                            <?php echo ucfirst($row->game_type); ?>
                                        </td><td data-title="State Name">
                                            <?php echo ucfirst($row->meta_key); ?>
                                        </td>
										<td data-title="City name">
                                            <?php echo ucfirst($row->meta_value); ?>
                                        </td>
        ...
        <div class="col-lg-12">
            <section class="panel">
                <div class="panel-body border-bottom">
                    ...
                    ?>
                    Number of Points <span class="badge-gray"><?php echo $start; ?></span> - <span class="badge-gray"><?php echo $till_record; ?></span> out of <span class="badge-gray"><?php echo $total_rows; ?></span>
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <section class="panel">
                ...
                <div class="panel-body">
                    <section id="no-more-tables">There are no Points added on site yet.</section>
                </div>
            </section>
        </div>
    </div>  
