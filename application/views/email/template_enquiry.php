...
<html dir="ltr" lang="en-US">
    ...
    <body>
        <div style="background-color: #E9EDF1; text-align:center;
            ...
            <table  align="center" style=" padding: 0 50px 10px; text-align:left;  table-layout:fixed; font-family:Arial, Helvetica, sans-serif;background-color: #FFFFFF;
                            ...
                            <?php if (isset($title)) { ?>
                                <tr>
                                    <td style="font-size:12px; color:#000; line-height:18px;">
                                        <p style="margin:0px;"><strong style="width:150px;">Course title:</strong>  <?php echo $title; ?></p>
                                    </td>
                                </tr>
                ...
                <?php } if (isset($large_text_message)) { //send description for post announcement & waning message through admin (mashuta)       ?>
                    <tr>
                        <td style="font-size:12px;color:#000; line-height:18px;">
                            <p style="margin:10px 0 0;"> <strong style="width:150px;">Message:</strong> <?php echo $large_text_message; ?></p>
                        </td>
                    </tr>
                <?php } if (isset($name)) { ?>
                    <tr>
                        <td style="font-size:12px;color:#000; line-height:15px;">
                            <p style="margin:0;"><strong style="width:150px;">Name:</strong>  <?php echo $name; ?></p>
                        </td>
                    </tr>
                    <?php
                }
                if (isset($subject)) {
                    ...
                    <tr>
                        <td style="font-size:12px; color:#000; line-height:18px;">
                            <p style="margin:0px;"><strong style="width:150px;">Subject:</strong>  <?php echo $subject; ?></p>
                        </td>
                    </tr>
                    <?php
                }
                ...
                <?php }if (isset($phone) and $phone) {
                    ?>
                    <tr>
                        <td style="font-size:12px;color:#000; line-height:15px;">
                            <p style="margin:0px;"><strong style="width:150px;">Telephone:</strong>  <?php echo $phone; ?></p>
                        </td>
                    </tr>
                <?php } if (isset($email)) {
                    ?>
                    <tr>
                        <td style="font-size:12px;color:#000; line-height:15px;">
                            <p style="margin:0"><strong style="width:150px;">Email Address:</strong>  <?php echo $email; ?></p>
                        </td>
                    </tr>
                ...
                <?php } if (isset($query)) {
                    ...
                    <tr>
                        <td style="font-size:12px;color:#000; line-height:15px;">
                            <p style="margin:0;"><strong style="width:150px;">Enquiry:</strong>  <?php echo $query; ?></p>
                        </td>
                    </tr>
                    <?php
                } if (isset($message)) {
                    ...
                    <tr>
                        <td style="font-size:12px;color:#000; line-height:15px;">
                            <p style="margin:0px;"><strong style="width:150px;">Additional Message:</strong>  <?php echo $message; ?></p>
                        </td>
                    </tr>
                    <?php
                }if (isset($from_name)) {
                    ...
                    <tr>
                        <td style="font-size:12px;color:#000; line-height:15px;">
                            <p style="margin:0px;"><strong style="width:150px;">Your name:</strong>  <?php echo $from_name; ?></p>
                        </td>
                    </tr>
                    <?php
                }
                if (isset($to_name)) {
                    ...
                    <tr>
                        <td style="font-size:12px;color:#000; line-height:15px;">
                            <p style="margin:0px;"><strong style="width:150px;">Friend’s name:</strong>  <?php echo $to_name; ?></p>
                        </td>
                    </tr>
                    <?php
                } if (isset($to_email)) {
                    ...
                    <tr>
                        <td style="font-size:12px;color:#000; line-height:15px;">
                            <p style="margin:0px;"><strong style="width:150px;">Friend’s e-mail:</strong>  <?php echo $to_email; ?></p>
                        </td>
                    </tr>
                    <?php
                }
                ...
                <?php } if (isset($booked_by) && $booked_by != '') { ?>
                    <tr>
                        <td style="font-size:12px;color:#000; line-height:15px;">
                            <p style="margin:0px;"><strong style="width:150px;">Course Booked By:</strong>  <?php echo $booked_by; ?></p>
                        </td>
                    </tr>
                <?php } if (isset($no_of_seat) && $no_of_seat != '') { ?>
                    <tr>
                        <td style="font-size:12px;color:#000; line-height:15px;">
                            <p style="margin:0px;"><strong style="width:150px;">No of Seat:</strong>  <?php echo $no_of_seat; ?></p>
                        </td>
                    </tr>
                <?php } if (isset($payment_mode) && $payment_mode != '') { ?>
                    <tr>
                        <td style="font-size:12px;color:#000; line-height:15px;">
                            <p style="margin:0px;"><strong style="width:150px;">Payment Mode:</strong>  <?php echo $payment_mode; ?></p>
                        </td>
                    </tr>
                    <?php
                }
