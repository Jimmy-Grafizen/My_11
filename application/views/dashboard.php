...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
            ...
            <title>aaa<?php echo SITE_TITLE . " - " . TAG_LINE . " ::  "; ?>Administration - <?php echo $title; ?></title>
                ...
                <meta name="msapplication-TileImage" content="<?php echo HTTP_PATH; ?>img/front/favicon/mstile-144x144.png">
                    <meta name="msapplication-config" content="<?php echo HTTP_PATH; ?>img/front/favicon/browserconfig.xml">
                        <meta name="theme-color" content="#ffffff">
                            ...
                            <link href="<?php echo HTTP_PATH . "css/" ?>font-awesome.css" rel="stylesheet" type="text/css" />
                            <?php
                                        ...
                                        <div class="header navbar navbar-inverse ">
                                            ...
                                            <div class="navbar-inner">
                                                ...
                                                <div class="home_dv <?php if (!$admin_detail['flag']) echo "small_menu" ?>" id="hdasf">
                                                    ...
                                                    <span>
                                                        <?php echo anchor("/admin/home/dashboard", img(array('src' => 'img/front/hm.png', 'alt' => SITE_TITLE, 'title' => SITE_TITLE, 'width' => '14')), array('escape' => false, 'class' => 'logo')); ?>
                                                    </span>
                                                </div>
                                                <a class="onlci  icon-align-justify" >&nbsp;</a>
                                                <div class="page-title">
                                                    <ul class="breadcrums" id="breadcrumb">
