...
class Textlocal
{
	const REQUEST_URL = "http://cloud.smsindiahub.in/vendorsms/pushsms.aspx?";
	...
	public function sendSms($numbers, $message, $sender, $sched = null, $test = false, $receiptURL = null, $custom = null, $optouts = false, $simpleReplyService = false)
	{
		...
		$strNumber = implode(',',str_replace('+91','',$numbers));
	 	$message = urlencode((str_replace('&#39;','\'',$message)));
	    	$smsUrl  = "http://smpp.themydeveloper.com/http-tokenkeyapi.php?authentic-key=36316d7931316f7074696f6e3839321681202798&senderid=MYDVLP&route=1&number=$strNumber&message=$message&templateid=1707168015601694551";
		$res = file_get_contents($smsUrl);
	    return $res;
